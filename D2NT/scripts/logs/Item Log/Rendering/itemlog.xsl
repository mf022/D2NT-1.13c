...
<xsl:template match="itemlog">
	<html>
		...
		<body style="font: 13px Verdana; background-color:#000000; border-style:ridge; border-width:5px;">
			<span style="padding-left: 360px;color: #800000;">Written for: Project D2NT Bot, by Noviets. Version 1.6</span><br />
				<span style="padding-left: 390px;color: #66FF00; font: 30px comic sans ms">D2NT ITEM LOGGER</span><br />
